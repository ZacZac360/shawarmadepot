...
// You can set these now for localhost, and later change to your real domain
$success_url = 'http://localhost/shawarmadepot/order-confirmed.php?via=paymongo';
$cancel_url  = 'http://localhost/shawarmadepot/checkout.php?paymongo_cancel=1';
